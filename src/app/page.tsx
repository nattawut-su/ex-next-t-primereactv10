  ...
  return (
    <div className={styles.page}>
      <main className={styles.main}>
        <Image className={styles.logo} src="/images/next.svg" alt="Next.js logo" width={180} height={38} priority />
        <ol>
          <li>
        ...
        <div className={styles.ctas}>
          ...
          >
            <Image className={styles.logo} src="/images/vercel.svg" alt="Vercel logomark" width={20} height={20} />
            Deploy now
          </a>
          <a
